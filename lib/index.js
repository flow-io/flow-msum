...
*
*      DESCRIPTION:
*         - Transform stream which calculates the sum of streamed numeric data in a moving window of chosen size
*
*      NOTES:
*        
*
...
(function() {
    ...
    var through = require( 'through' ); // through module
	...
	sum = 0,    // sum of values in buffer window
